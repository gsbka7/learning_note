...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3-其他" tabindex="-1"><a class="header-anchor" href="#_3-其他" aria-hidden="true">#</a> 3. 其他</h3><p>db.collection.deleteOne()</p><p>db.collection.deleteMany()</p><div class="custom-container tip"><p class="custom-container-title">提示</p><p>一般而言資料庫的資料不會刪除，會在資料中新增一個字段來表示資料是否被刪除</p></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>db.stu.insert([
    {
        name: &quot;name1&quot;,
        isDel: 0 // 表示刪除狀態
    },
